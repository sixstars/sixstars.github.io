...
function geronimo() {
	...
	function Game() {
		...
		this.newGame = function () {
			...
			if (r) {
				...
				if(global_resume > 0){
					...
					var r = confirm("K3Y F0r next 1eve1 is: H@ppy*G@ME");
					this.init(0);
					this.forceResume();
				}
		...
		this.showHighscoreForm = function () {
			...
			if(this.win == 1){
				this.pauseAndShowMessage("You win!  The k3Y for next g@me is: H@ppy*G@ME", "Total Score: " + this.score.score + (HIGHSCORE_ENABLED ? inputHTML : ''));
			}
			else{
